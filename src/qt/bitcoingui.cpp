...
void BitcoinGUI::createActions()
{
    ...
    addressBookAction = new QAction(QIcon(":/icons/address-book"), tr("&Cage Book"), this);
    ...
    sendCoinsAction = new QAction(QIcon(":/icons/send"), tr("&Send CAGE"), this);
